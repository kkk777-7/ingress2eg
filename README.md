...
| **Buffer Limits** | [`proxy-body-size`](https://kubernetes.github.io/ingress-nginx/user-guide/nginx-configuration/annotations/#custom-max-body-size) | `ClientTrafficPolicy` ([Connection.BufferLimit](https://gateway.envoyproxy.io/docs/api/extension_types/#clientconnection)) | Client request buffer size limits |
